...
public class MainActivity extends Activity {
    ...
    @Override protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        getSharedPreferences("radio",0).edit().putString("user_audio_uris",all.toString()).putInt("user_audio_count",picked.size()).apply();
        ...
        log.setText("Músicas carregadas: "+picked.size()+"\n"+names);
        Toast.makeText(this,picked.size()+" música(s) adicionada(s) à automação.",Toast.LENGTH_LONG).show();
    }
