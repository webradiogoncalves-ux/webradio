...
public class MainActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle b) {
        ...
        bind();
        DailyWordReceiver.createChannel(this);
        scheduleDailyWordNotification(this);
        ...
        clockRun.run();
        if (getIntent().getBooleanExtra("open_word", false)) h.postDelayed(this::showWord, 500);
    ...
    public static void scheduleDailyWordNotification(Context context) {
        AlarmManager am = (AlarmManager) context.getSystemService(Context.ALARM_SERVICE);
        if (am == null) return;
        Intent i = new Intent(context, DailyWordReceiver.class);
        PendingIntent pi = PendingIntent.getBroadcast(context, 7001, i,
